...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TK_IDENTIFICADOR_B = 259,      /* TK_IDENTIFICADOR_B  */
    ...
    TK_LITERAL_CARACTER = 277,     /* TK_LITERAL_CARACTER  */
    TK_DEFINICION_TIPO = 278,      /* TK_DEFINICION_TIPO  */
    TK_TIPOBASE = 279,             /* TK_TIPOBASE  */
